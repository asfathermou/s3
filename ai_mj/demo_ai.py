...
from ai_mj.ai_algorithm_1 import AIAlgorithm
...
class DemoAI:
    ...
    def start(self):
        ...
        self._algorithm.set_scenario(self._scenario, self._graph)
    ...
    def _call_back(self, response):
        ...
        if response["type"] == const.BEGIN_GAME:
            ...
            if battle_state.data['judgements'] != []:
                print(battle_state.data['judgements'])
            ...
            if time_section_id == 20101:
                print("情报支援时节")

            print("other_infomation:")
            print(battle_state.data['other_information'])

            # if battle_state.data['other_information'] != []:
            #     print('aa')
            print("我方算子id， 位置， 状态， 编队id:")
            for i in battle_state.our_operators:
                print(i.operator_id, i.position, i.state, i.formation_id if hasattr(i, 'formation_id') else -1)
            ...
            # self._algorithm.set_judgement_string(judgement_string)
                ...
                # self._update_operator.cal_attack_ids()
